# Moonn SEO Growth Check — 2026-06-22
...
- Source-level debt remains, but the missing-alt count is lower than earlier baseline:
...
- The 2026-05-21 sprint is now at approximately T+32.
...
- Новое правило: if GUI cabinet verification is skipped to protect authenticated browser state, the run may still record raw/rendered evidence but must not update cabinet statuses as if freshly checked.
