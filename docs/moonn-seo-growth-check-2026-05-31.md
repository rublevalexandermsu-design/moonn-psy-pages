# Moonn SEO Growth Check — 2026-05-31
...
- Infra blocker persists: DNS resolution for `moonn.ru` is broken on this host (`DNS-имя не существует` / `[Errno 11001] getaddrinfo failed`).
